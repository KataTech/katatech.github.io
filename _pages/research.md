...
[2] **Hung, K.**, Zalles, A., et al. (2024). [Towards Ecological Network Analysis with Gromov-Wasserstein Distances](https://www.climatechange.ai/papers/iclr2024/6). ICLR 2024 Workshop on Tackling Climate Change with Machine Learning.

[3] Zalles, A., **Hung, K.**, et al. (2023). [Network Regression with Wasserstein Distances](/assets/papers/zalles2023_network_regression.pdf). NeurIPS 2023 Workshop on Optimal Transport and Machine Learning.
